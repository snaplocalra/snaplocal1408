...
class RegularPostModel extends SocialPostModel implements AllowOwnPostEdit {
  String caption;
  RegularPostModel({
  ...
  factory RegularPostModel.fromMap(Map<String, dynamic> map) {
    final parentFromJson = SocialPostModel.fromJson(map);

    return RegularPostModel(
      caption: map["caption"],
