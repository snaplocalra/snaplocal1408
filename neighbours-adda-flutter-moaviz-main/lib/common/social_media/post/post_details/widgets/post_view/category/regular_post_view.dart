...
class RegularPostView extends StatelessWidget {
  ...
  final RegularPostModel regularPostModel;

  const RegularPostView({
    super.key,
    ...
    required this.regularPostModel,
  });

  @override
  Widget build(BuildContext context) {
    final mqSize = MediaQuery.sizeOf(context);
    final postDetails = regularPostModel;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Stack(
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    if (postDetails.taggedlocation != null)
                    //Tagged location
                      Padding(
                    ...
                    //Post Caption
                    Visibility(
                      visible: postDetails.caption.isNotEmpty,
                      child: Padding(
                    ...
                    if(postDetails.media.isNotEmpty)
                      PostMediaVerticalViewer(media: regularPostModel.media,onVideoViewCount: onVideoViewCount,),
            ...
            //Post vertical view
            //if (verticalPostView)
            //PostMediaVerticalViewer(media: regularPostModel.media)
          ],
        ),
      ),
    );
